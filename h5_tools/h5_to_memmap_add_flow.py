...
def h5_to_memmap(h5_file_path, input_flow_path, output_base_path):
...
if __name__ == "__main__":
    ...
    path = 'E:/4000datasets/EventCamera/e2v_traindata/sequence_0000000000/events_noslomo/events.h5'
    flow_path = 'E:/4000datasets/EventCamera/e2v_traindata/sequence_0000000000/flow'
    output_path = 'E:/4000datasets/EventCamera/e2v_traindata/sequence_0000000000'

    # bagname = os.path.splitext(os.path.basename(path))[0]
    # if output_dir is None:
    #     output_path = os.path.join(os.path.dirname(os.path.abspath(path)), bagname)
    # else:
    #     output_path = os.path.join(output_dir, bagname)

    h5_to_memmap(path, flow_path, output_path)
