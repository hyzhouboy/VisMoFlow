...
def extract_rosbag(rosbag_path, output_path, event_topic, image_topic=None,
    ...
    with rosbag.Bag(rosbag_path, 'r') as bag:
        ...
        ep.add_metadata(num_pos, num_neg, last_ts-t0, t0, last_ts, 0, img_cnt, flow_cnt, sensor_size)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", default="/mnt/e/4000datasets/EventCamera/HQF_ECCV2020/h5", help="Folder where to extract the data")
