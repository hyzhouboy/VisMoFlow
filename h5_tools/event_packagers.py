...
class hdf5_packager(packager):
    ...
    def package_events(self, events):
        self.append_to_dataset(self.event_xs, events['x'])
        self.append_to_dataset(self.event_ys, events['y'])
        self.append_to_dataset(self.event_ts, events['t'])
        self.append_to_dataset(self.event_ps, events['p'])
    ...
    def add_event_indices(self):
        ...
        # self.events_file.attrs['event_idx'] = event_indices_lst
        # self.events_file.attrs['length'] = length
